...
readonly ISO_FILE="bootstrap.iso"
readonly ISO_PATH="$SCRIPT_DIR/build/$ISO_FILE"
...
export TF_VAR_iso_file="$ISO_FILE"
...
tofu -chdir="$SCRIPT_DIR/terraform" destroy -auto-approve